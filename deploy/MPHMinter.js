...
module.exports = async ({
  ...
  if (chainId === 1) {
    ...
    if (deployResult.newlyDeployed) {
      ...
      await vesting02Contract.transferOwnership(
        config.govTreasury,
        true,
        false,
        {
    ...
    if (deployResult.newlyDeployed) {
      log(`DummyMPHMinter deployed at ${deployResult.address}`);
    }
  }
};
module.exports.tags = ["MPHMinter"];
module.exports.dependencies = config.isEthereum ? ["Vesting02"] : [];
