...
module.exports = async ({
  ...
  await mphMinterContract.transferOwnership(config.govTreasury, {
    from: deployer
  });
  ...
  const mphIssuanceModelContract = await MPHIssuanceModel.at(
    mphIssuanceModelDeployment.address
  );
  await mphIssuanceModelContract.transferOwnership(config.govTreasury, {
    from: deployer
  });
  ...
  await rewardsContract.transferOwnership(config.govTreasury, {
    from: deployer
  });
